    ...
    public static final ItemGroup FLORIN_ITEMS_GROUP = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().icon(() -> new ItemStack(ModItems.PINEAPPLE))
                    ...
                    .entries((displayContext, entries) -> {
                        ...
                        entries.add(ModBlocks.GREY_BIRCH_LOG);
                        entries.add(ModBlocks.STRIPPED_GREY_BIRCH_LOG);
                        entries.add(ModBlocks.GREY_BIRCH_PLANKS);
                        entries.add(ModBlocks.GREY_BIRCH_LEAVES);
                        entries.add(ModBlocks.GREY_BIRCH_SAPLING);
